...
@NgModule({
  declarations: [LaporanPenjualanComponent, ExportLaporanComponent, RekeningKoranComponent, ExportKorporasiProformaComponent,LaporanBuybackComponent,ExportLaporanBuybackBycodeComponent, LaporanBuybackManualComponent, ExportLaporanBuybackManualComponent ],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
