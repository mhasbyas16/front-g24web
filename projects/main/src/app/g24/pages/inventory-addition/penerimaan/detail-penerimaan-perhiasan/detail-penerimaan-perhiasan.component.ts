...
@Component({
  ...
  templateUrl: './detail-penerimaan-perhiasan.component.html',
  styleUrls: ['./detail-penerimaan-perhiasan.component.scss'],
  providers : [DatePipe]
  // changeDetection: ChangeDetectionStrategy.OnPush
})
export class DetailPenerimaanPerhiasanComponent extends BasePersistentFields implements OnInit, AfterViewInit
{
  ...
  onSimpan()
  {
    ...
    {
      this.toastr.show("PO sudah di Terima Full / di Tolak", "Terima says");
      return;
    }
