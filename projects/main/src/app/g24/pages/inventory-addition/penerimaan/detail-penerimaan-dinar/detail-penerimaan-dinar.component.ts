...
@Component({
  ...
  templateUrl: './detail-penerimaan-dinar.component.html',
  styleUrls: ['./detail-penerimaan-dinar.component.scss'],
  providers : [DatePipe]
  // changeDetection: ChangeDetectionStrategy.OnPush
})
export class DetailPenerimaanDinarComponent extends BasePersistentFields implements OnInit, AfterViewInit, IDetailCallbackListener
{
  @ViewChild('container', { read: ViewContainerRef}) container : ViewContainerRef;

  // @ViewChild('inisiasi', {static: false}) inisiasi : NgForm;
  @ViewChild('product') product : ElementRef;
  @ViewChild('item_terima') modalItemTerima : DetailItemPenerimaanDinarComponent;
