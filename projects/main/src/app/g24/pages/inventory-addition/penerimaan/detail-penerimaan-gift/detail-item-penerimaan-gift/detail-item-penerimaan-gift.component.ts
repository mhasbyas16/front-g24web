 ...
 */
@Component({
  selector: 'detail-item-penerimaan-gift',
  templateUrl: './detail-item-penerimaan-gift.component.html',
  styleUrls: ['./detail-item-penerimaan-gift.component.scss']
})
export class DetailItemPenerimaanGiftComponent implements OnInit {
