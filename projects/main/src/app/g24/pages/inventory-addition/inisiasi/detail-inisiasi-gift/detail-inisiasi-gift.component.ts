...
@Component({
  ...
  templateUrl: './detail-inisiasi-gift.component.html',
  styleUrls: ['./detail-inisiasi-gift.component.scss']
  // changeDetection: ChangeDetectionStrategy.OnPush
})
// @DContent(InisiasiComponent.key)
export class DetailInisiasiGiftComponent extends BasePersistentFields implements OnInit, AfterViewInit
{
