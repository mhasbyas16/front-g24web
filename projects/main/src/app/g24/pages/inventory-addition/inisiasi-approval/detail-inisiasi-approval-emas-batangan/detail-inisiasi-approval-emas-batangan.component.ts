...
import { DetailItemInisiasiApprovalEmasBatanganComponent  } from './detail-item-inisiasi-approval-emas-batangan/detail-item-inisiasi-approval-emas-batangan.component';
...
@Component({
  ...
  templateUrl: './detail-inisiasi-approval-emas-batangan.component.html',
  styleUrls: ['./detail-inisiasi-approval-emas-batangan.component.scss']
})
export class DetailInisiasiApprovalEmasBatanganComponent extends BasePersistentFields implements OnInit {

  @ViewChild('product') product : ElementRef;
  
  @ViewChild('item_terima') modalItemTerima : DetailItemInisiasiApprovalEmasBatanganComponent;
  btoa = btoa;
  parseInt = parseInt;
  console = console;
  Object = Object;
  ...
  onProductChanged()
  {
    ...
    {
      let gift = this.products[i];
      if(gift.code == "c05")
      {
        this.input['product-category'] = gift;
        break;
      }
    }
  }
  ...
  doSearch(form : FormGroup)
  {
    ...
    let params = "?product-category.code=c05" + create_p + order_status_p + unit_p + no_po_p;
