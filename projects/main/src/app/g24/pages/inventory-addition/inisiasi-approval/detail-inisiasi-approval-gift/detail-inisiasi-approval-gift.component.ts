...
import { DetailItemInisiasiApprovalGiftComponent } from './detail-item-inisiasi-approval-gift/detail-item-inisiasi-approval-gift.component';
...
@Component({
  selector: 'detail-inisiasi-approval-gift',
  templateUrl: './detail-inisiasi-approval-gift.component.html',
  styleUrls: ['./detail-inisiasi-approval-gift.component.scss']
})
export class DetailInisiasiApprovalGiftComponent extends BasePersistentFields implements OnInit {

  @ViewChild('product') product : ElementRef;
  
  @ViewChild('item_terima') modalItemTerima : DetailItemInisiasiApprovalGiftComponent;;
  btoa = btoa;
  parseInt = parseInt;
  console = console;
  Object = Object;
  ...
  doSearch(form : FormGroup)
  {
    ...
    let params = "?product-category.code=c04" + create_p + order_status_p + unit_p + no_po_p;
