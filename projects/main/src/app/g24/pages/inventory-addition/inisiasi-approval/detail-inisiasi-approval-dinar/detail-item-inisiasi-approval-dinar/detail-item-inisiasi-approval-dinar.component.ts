...
@Component({
  ...
  templateUrl: './detail-item-inisiasi-approval-dinar.component.html',
  styleUrls: ['./detail-item-inisiasi-approval-dinar.component.scss']
})
export class DetailItemInisiasiApprovalDinarComponent implements OnInit {
  ...
  private title : string = "Detail Approval Dinar";
  public get Title()
  {
    return this.title;
  }
