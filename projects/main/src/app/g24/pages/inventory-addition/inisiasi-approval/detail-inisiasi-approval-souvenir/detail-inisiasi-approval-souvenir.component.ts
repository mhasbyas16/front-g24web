...
import { DetailItemInisiasiApprovalSouvenirComponent } from './detail-item-inisiasi-approval-souvenir/detail-item-inisiasi-approval-souvenir.component';
...
@Component({
  selector: 'detail-inisiasi-approval-souvenir',
  templateUrl: './detail-inisiasi-approval-souvenir.component.html',
  styleUrls: ['./detail-inisiasi-approval-souvenir.component.scss']
})
export class DetailInisiasiApprovalSouvenirComponent extends BasePersistentFields implements OnInit {
  ...
  @ViewChild('item_terima') modalItemTerima : DetailItemInisiasiApprovalSouvenirComponent;
  btoa = btoa;
  parseInt = parseInt;
  console = console;
  Object = Object;
  ...
  onProductChanged()
  {
    ...
    {
      let souvenir = this.products[i];
      if(souvenir.code == "c02")
      {
        this.input['product-category'] = souvenir;
        break;
      }
    }
  }
  ...
  doSearch(form : FormGroup)
  {
    ...
    let params = "?product-category.code=c02" + create_p + order_status_p + unit_p + no_po_p;
